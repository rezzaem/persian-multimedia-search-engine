...
PERPLEXITY_API_KEY = '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'
...
def search_videos():
    ...
    analysis_data = eval(analysis_result)  # Note: eval should be replaced with a safer parsing method in production
